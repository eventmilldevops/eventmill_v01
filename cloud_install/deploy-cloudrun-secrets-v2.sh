#!/bin/bash
# =============================================================================
# Event Mill — Cloud Run Deployment with Secret Manager (v2)
# =============================================================================
#
...
#      v2 captures stderr and prints what GCP actually said.
#
...
#      provision-gcp-project-v2.sh. This script only VERIFIES.
#
...
#   bash cloud_install/deploy-cloudrun-secrets-v2.sh
#
#   # Skip the build and redeploy the existing :latest image
#   SKIP_BUILD=1 bash cloud_install/deploy-cloudrun-secrets-v2.sh
#
#   # Preflight only, change nothing
#   DRY_RUN=1 bash cloud_install/deploy-cloudrun-secrets-v2.sh
# =============================================================================
...
# Bucket prefix: same default as provision-gcp-project.sh line 42.
...
echo "⚙ Event Mill — Cloud Run Deployment (Secret Manager, v2)"
echo "========================================================="
...
#     provision-gcp-project-v2.sh (Section 8), at bootstrap.
#
...
if [ "${UNVERIFIED}" -ne 0 ]; then
    ...
    echo "     bash cloud_install/provision-gcp-project-v2.sh"
    echo ""
...
if [ "${ALLOW_UNAUTH}" = "true" ]; then
    ...
    echo "     ALLOW_UNAUTH=false bash cloud_install/deploy-cloudrun-secrets-v2.sh"
